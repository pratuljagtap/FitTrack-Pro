...
const initializeSampleData = () => {
  ...
  const sampleExercises = [
    ...
    },
    {
      ...
      muscle_group: 'back',
      equipment: 'barbell',
      instructions: 'Stand with feet hip-width apart, hinge at hips, lift bar keeping back straight.',
      difficulty: 'intermediate'
    }
  ];
  ...
  const sampleGoals = [
    {
      ...
      current_value: 175,
      unit: 'lbs',
      target_date: new Date(Date.now() + 60 * 86400000).toISOString().split('T')[0], // 60 days from now
      status: 'active'
    },
    {
      id: '2',
